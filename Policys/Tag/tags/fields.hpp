...
typedef FieldDecl<field_location_tags::Header,                                        //by yin
                  uint64_t,                                                           //by yin
                  tlv::LcdTag> LcdTagField;                                           //by yin
BOOST_CONCEPT_ASSERT((Field<LcdTagField>));                                           //by yin

typedef FieldDecl<field_location_tags::Header,                                        //by yin
                  uint64_t,                                                           //by yin
                  tlv::IdeaTag> IdeaTagField;                                         //by yin
BOOST_CONCEPT_ASSERT((Field<IdeaTagField>));                                          //by yin

typedef FieldDecl<field_location_tags::Header,                                        //by yin
                  uint64_t,                                                           //by yin
                  tlv::RanTag> RanTagField;                                           //by yin
BOOST_CONCEPT_ASSERT((Field<RanTagField>));                                           //by yin

typedef FieldDecl<field_location_tags::Header,                                        //by yin
                  uint64_t,                                                           //by yin
                  tlv::PopTag> PopTagField;                                           //by yin
BOOST_CONCEPT_ASSERT((Field<PopTagField>));                                           //by yin
