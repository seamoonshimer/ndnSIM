...
main(int argc, char* argv[])
{
  ...
  ndn::StackHelper ndnHelper;
    ...
    ndnHelper.SetOldContentStore("ns3::ndn::cs::Lru","MaxSize","130");         // 边缘节点存储容量 50
    ndnHelper.Install(L1);
    ndnHelper.SetOldContentStore("ns3::ndn::cs::Lru","MaxSize","64");         // 边缘节点存储容量 50
    ndnHelper.Install(L2);
    ndnHelper.SetOldContentStore("ns3::ndn::cs::Lru","MaxSize","32");         // 边缘节点存储容量 50
    ndnHelper.Install(L3);
    ndnHelper.SetOldContentStore("ns3::ndn::cs::Lru","MaxSize","16");         // 边缘节点存储容量 50
    ndnHelper.Install(L4);
    ndnHelper.SetOldContentStore("ns3::ndn::cs::Lru","MaxSize","8");         // 边缘节点存储容量 50
