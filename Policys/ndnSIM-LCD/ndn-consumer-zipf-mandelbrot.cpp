...
//  NS_LOG_DEBUG(m_q << " and " << m_s << " and " << m_N);                                        //LOG by yin
...
// LCD (log)
//--------------------------------------------------------------------------------------------------------------------------------------------------------------- 
//  std::cout<<Simulator::Now().ToDouble (Time::S)<<" consumer:zipf send "<<interest->getName()<<" in user "<<GetNode()->GetId()-31<<std::endl;

//  std::string str = interest->getName().toUri();
//  int pos1 = str.find("x");
//  int pos2 = str.rfind("/");
//  std::cout<<Simulator::Now().ToDouble (Time::S)<<" "<<str.substr(pos1+1,1)<<" "<<str.substr(pos1+2,pos2-pos1-2)<<" "<<GetNode()->GetId()-31<<std::endl;
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
