...
// Ran (1.set Ran hup num | 2.log)
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
  int hopNum = (int)(Simulator::Now().ToDouble (Time::S) * 100000) % 5;                                    
  data->setTag(make_shared<lp::RanTag>(hopNum + 2));
  
  int Ti = Simulator::Now().ToDouble (Time::S); 
//  std::cout << Ti << " producer return data " << data->getName() << " add RanTag " << data->getTag<lp::RanTag>()->get() << std::endl; 
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
