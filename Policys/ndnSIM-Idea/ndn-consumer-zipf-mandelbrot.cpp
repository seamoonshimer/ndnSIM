...
// Idea (1.set IdeaTag as seq | 2.log)
//----------------------------------------------------------------------------------------------------------------------------------------------------------
  interest->setTag(make_shared<lp::IdeaTag>(seq));
//  std::cout<<Simulator::Now().ToDouble (Time::S)<<" consumer:zipf send "<<interest->getName()<<" in user "<<GetNode()->GetId()-31<<
//           " set IdeaTag "<<seq<<std::endl;
//----------------------------------------------------------------------------------------------------------------------------------------------------------
