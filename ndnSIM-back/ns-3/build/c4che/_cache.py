...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-kjnyAR/python2.7-2.7.17=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_OPENSSL': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_SQLITE3': '', 'HAVE_LIBXML2': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_STD_TO_STRING': '', 'HAVE_PYTHON_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_PTHREAD': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['tutorial', 'energy', 'naming', 'matrix-topology', 'udp-client-server', 'traffic-control', 'socket', 'stats', 'wireless', 'udp', 'realtime', 'ipv6', 'routing', 'tcp', 'error-model']
...
NS3_EXECUTABLE_PATH = ['/home/yin/Research/Static/ndnSIM-back/ns-3/build/src/fd-net-device', '/home/yin/Research/Static/ndnSIM-back/ns-3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/yin/Research/Static/ndnSIM-back/ns-3/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3-dev'
WITH_PYBINDGEN = '/home/yin/Research/Static/ndnSIM-back/pybindgen'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/yin/Research/Static/ndnSIM-back/ns-3/build/ns3/config-store-config.h', '/home/yin/Research/Static/ndnSIM-back/ns-3/build/ns3/core-config.h', '/home/yin/Research/Static/ndnSIM-back/ns-3/build/ns3/ndnSIM/ndn-cxx/detail/config.hpp', '/home/yin/Research/Static/ndnSIM-back/ns-3/build/ns3/ndnSIM/NFD/core/config.hpp']
cprogram_PATTERN = '%s'
