...
//  ndnHelper.InstallAll();
  ...
  // g
  Config::Set("/NodeList/1/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  // s1~s2
  Config::Set("/NodeList/2/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/3/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  // s3~s6
  Config::Set("/NodeList/4/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/5/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/6/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/7/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  // u1~u12
  Config::Set("/NodeList/8/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/9/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/10/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/11/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/12/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/13/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/14/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/15/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/16/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/17/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/18/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
  Config::Set("/NodeList/19/$ns3::ndn::ContentStore/CacheProbability", DoubleValue(0.6));
