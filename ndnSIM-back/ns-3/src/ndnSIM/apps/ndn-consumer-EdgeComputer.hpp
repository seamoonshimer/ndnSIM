...
#ifndef NDN_CONSUMER_EDGECOMPUTER_H_
#define NDN_CONSUMER_EDGECOMPUTER_H_
...
class ConsumerEdgeComputer : public ConsumerCbr {
public:
  static TypeId
  GetTypeId();
   ...
   */
  ConsumerEdgeComputer();
  virtual ~ConsumerEdgeComputer();
...
#endif /* NDN_CONSUMER_EDGECOMPUTER_H_ */
